    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white flex flex-col items-center px-4 py-16">
      <div className="max-w-2xl w-full space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <ShareButton lessonTitle="ai-and-education" />
        </div>
        ...
        {/* Rating */}
        <LessonFeedback lessonId="ai-and-education" />
        <LessonRating lessonId="ai-and-education" />
        <ReviewLaterButton lessonId="ai-and-education" />
