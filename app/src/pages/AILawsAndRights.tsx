    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white flex flex-col items-center px-4 py-16">
      <div className="max-w-2xl w-full space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <ShareButton lessonTitle="ai-laws-and-rights" />
        </div>
        ...
        {/* Rating */}
        <LessonFeedback lessonId="ai-laws-and-rights" />
        <LessonRating lessonId="ai-laws-and-rights" />
        <ReviewLaterButton lessonId="ai-laws-and-rights" />
