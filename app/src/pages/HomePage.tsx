  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        title: 'AI and welfare benefits — DWP fraud detection, Universal Credit algorithms, and your rights',
        description: 'How AI processes benefit claims, detects fraud, and makes sanctions decisions — the SyRI case, false positives, and how to challenge an automated DWP decision.',
        readingTime: '7 min',
        icon: '&#x1F3DB;&#xFE0F;',
      ...
      },
      {
        ...
        title: 'AI and cybercrime — AI-powered attacks, deepfake fraud, and defence',
        description: 'How criminals use AI to launch phishing attacks, create convincing deepfakes for fraud, and automate cyberattacks — and how defenders use AI to fight back.',
        readingTime: '6 min',
        icon: '&#x1F5A5;&#xFE0F;',
      ...
      },
      {
        ...
        title: 'AI and autonomous vehicles — self-driving cars, UK trials, and the safety debate',
        description: 'How self-driving car AI works, the current state of UK trials, what the fatal accidents have taught engineers, and the regulatory questions still unresolved.',
        readingTime: '7 min',
        icon: '&#x1F697;',
      ...
      },
      {
        ...
        title: 'AI and financial advice — robo-advisors, FCA rules, and algorithmic bias',
        description: 'How AI-powered investment platforms and robo-advisors work, what the FCA requires, and why algorithmic financial advice can perpetuate existing wealth inequalities.',
        readingTime: '6 min',
        icon: '&#x1F4B7;',
      ...
      {
        id: 'ai-and-shopping',
        title: 'AI and shopping — recommendation engines, dynamic pricing, and Amazon Go',
        description: 'How AI decides what products you see, why prices change by the minute, what cashierless stores mean for jobs, and how to spot personalised pricing.',
        readingTime: '5 min',
        icon: '&#x1F6D2;',
      ...
      },
      {
        ...
        title: 'AI and translation — DeepL, Google Translate, and the future for human translators',
        description: 'How neural machine translation works, where AI translation excels and fails, what professional translators do that AI cannot, and the cultural nuances machines miss.',
        readingTime: '5 min',
        icon: '&#x1F310;',
      ...
      },
      {
        ...
        description: 'How algorithms assign shifts, calculate pay, and can deactivate workers without explanation — and what UK law says about the rights of platform workers.',
        readingTime: '6 min',
        icon: '&#x1F6B4;',
      ...
      },
      {
        ...
        title: 'AI and 3D printing — medical implants, design optimisation, manufacturing, and aerospace',
        description: 'How AI is used to design and optimise 3D printed objects, from personalised medical implants to aircraft parts, and how generative design is changing manufacturing.',
        readingTime: '6 min',
        icon: '&#x1F5A8;&#xFE0F;',
      ...
      },
      {
        ...
        title: 'AI and addiction recovery — chatbots, relapse prediction, NHS, and digital therapeutics',
        description: 'How AI tools are being used to support people recovering from addiction, predict relapse risk, and supplement NHS services.',
        readingTime: '6 min',
        icon: '&#x1F49A;',
      ...
      },
      {
        ...
        title: 'AI and ageing and elder care — fall detection, dementia support, care robots, and loneliness',
        description: 'How AI is being deployed in care homes and homes to detect falls, support people with dementia, and address loneliness in older adults.',
        readingTime: '6 min',
        icon: '&#x1F9D3;',
      ...
      },
      {
        ...
        title: 'AI and fraud and identity theft — bank fraud detection, synthetic identity fraud, and deepfake scams',
        description: 'How AI fights financial fraud and how criminals use AI to commit it — from synthetic identity fraud to AI-generated voice cloning scams.',
        readingTime: '7 min',
        icon: '&#x1F6AB;',
      ...
      {
        id: 'ai-and-logistics',
        title: 'AI and logistics — route optimisation, warehouse robots, demand forecasting, and supply chains',
        description: 'How AI powers the systems that move goods around the world — from Amazon warehouse robots to route optimisation software used by delivery drivers.',
        readingTime: '6 min',
        icon: '&#x1F69A;',
      ...
      },
      {
        ...
        title: 'AI and sports medicine — injury prediction, wearables, recovery optimisation, and athlete monitoring',
        description: 'How AI analyses athlete data to predict injury risk, optimise training and recovery, and support sports medicine practitioners in elite and recreational sport.',
        readingTime: '6 min',
        icon: '&#x1F3C3;',
      ...
      {
        id: 'ai-and-education-tech',
        title: 'AI and education tech — adaptive learning, marking automation, and teacher tools',
        description: 'How AI is being used in education technology products to personalise learning, automate marking, and provide teaching insights.',
        readingTime: '6 min',
        icon: '&#x1F4DA;',
        to: '/learn/ai-and-education-tech',
        color: 'yellow',
        difficulty: 'Beginner',
      },
      {
        id: 'ai-and-mental-health-care',
        title: 'AI and mental health care — diagnosis support, crisis prediction, and NHS waiting lists',
        description: 'How AI tools are being used to support mental health diagnosis, predict crisis episodes, and help address NHS waiting lists for mental health services.',
        readingTime: '6 min',
        icon: '&#x1F9E0;',
      ...
      },
      {
        ...
        title: 'AI and music creation — composition tools, stem separation, mastering, and the rights debate',
        description: 'How AI is being used by musicians to compose, produce, and master music — and the ongoing debate about copyright and creativity.',
        readingTime: '6 min',
        icon: '&#x1F3B5;',
      ...
      {
        id: 'ai-and-taxes',
        title: 'AI and taxes — HMRC Making Tax Digital, fraud detection, AI tax advisors, and compliance',
        description: "How AI is changing tax collection and advice — from HMRC's fraud detection to AI tools that help small businesses with tax returns.",
        readingTime: '6 min',
        icon: '&#x1F4B3;',
