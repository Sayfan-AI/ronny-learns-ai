...
const ALL_LESSONS: Array<{ id: string; icon: string; title: string; to: string; difficulty: 'Beginner' | 'Intermediate' | 'Advanced'; readingTime: string }> = [
  ...
  { id: 'ai-and-cybersecurity',  icon: '&#x1F512;', title: 'AI and cybersecurity',                    to: '/learn/ai-and-cybersecurity',           difficulty: 'Intermediate', readingTime: '6 min' },
  ...
  { id: 'ai-and-the-nhs',        icon: '&#x1F3E5;', title: 'AI and the NHS',                          to: '/learn/ai-and-the-nhs',                 difficulty: 'Intermediate', readingTime: '7 min' },
