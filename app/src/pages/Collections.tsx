...
const COLLECTIONS: Collection[] = [
  ...
  },
  {
    id: 'ai-at-work',
    title: 'AI at work',
    description: 'Lessons about how AI is changing jobs, workplaces, and the tools professionals use.',
    icon: '&#x1F4BC;',
    color: 'text-emerald-700',
    borderColor: 'border-emerald-200',
    bgColor: 'bg-emerald-50',
    lessons: [
      { id: 'ai-and-jobs',         title: 'AI and jobs',                   to: '/learn/ai-and-jobs',         icon: '&#x1F4BC;' },
      { id: 'ai-productivity-tools', title: 'AI and your productivity',    to: '/learn/ai-productivity-tools', icon: '&#x26A1;' },
      { id: 'ai-in-your-apps',     title: 'AI in the apps you already use', to: '/learn/ai-in-your-apps',   icon: '&#x1F4F1;' },
      { id: 'how-to-use-ai-safely', title: 'How to use AI safely',         to: '/learn/how-to-use-ai-safely', icon: '&#x1F6E1;&#xFE0F;' },
  ...
  },
  {
    ...
    description: 'How AI affects fairness, democracy, law, and the information we consume.',
    icon: '&#x1F3DB;&#xFE0F;',
  ...
  },
  {
    id: 'ai-and-you',
    title: 'AI and you',
    description: 'The personal impact of AI — your privacy, your safety, and your everyday life.',
    icon: '&#x1F9D1;',
    color: 'text-purple-700',
    borderColor: 'border-purple-200',
    bgColor: 'bg-purple-50',
    lessons: [
      { id: 'ai-and-privacy',     title: 'AI and privacy',                to: '/learn/ai-and-privacy',       icon: '&#x1F512;' },
      { id: 'how-to-use-ai-safely', title: 'How to use AI safely',        to: '/learn/how-to-use-ai-safely', icon: '&#x1F6E1;&#xFE0F;' },
      { id: 'ai-and-social-media', title: 'AI and social media',          to: '/learn/ai-and-social-media',  icon: '&#x1F4F2;' },
      { id: 'ai-for-accessibility', title: 'AI for accessibility',        to: '/learn/ai-for-accessibility', icon: '&#x267F;' },
      { id: 'ai-and-mental-health', title: 'AI and mental health',        to: '/learn/ai-and-mental-health', icon: '&#x1F9E0;' },
    ],
  },
  {
