...
const SEARCH_INDEX: SearchItem[] = [
  ...
  { type: 'lesson', title: 'AI and the gig economy',              description: 'How Uber, Deliveroo, and other platforms use AI to allocate jobs, set pay, monitor workers, and what UK law says about your rights.', to: '/learn/ai-and-gig-economy', difficulty: 'Intermediate', topicGroup: 'AI and society' },
  { type: 'lesson', title: 'AI and education technology (EdTech)', description: 'AI tutors, adaptive learning platforms, exam surveillance software, and how AI is personalising education in UK schools.', to: '/learn/ai-and-edtech', difficulty: 'Intermediate', topicGroup: 'AI in the real world' },
  { type: 'lesson', title: 'AI and sport (fan experience)',        description: 'VAR controversy, AI highlight reels, smart stadiums, betting algorithms, and the data your club collects about you.', to: '/learn/ai-and-sport-fan-experience', difficulty: 'Intermediate', topicGroup: 'AI in the real world' },
  { type: 'lesson', title: 'AI and cybersecurity (offensive AI)',  description: 'How criminals use AI to attack — perfect phishing emails, automated hacking, voice cloning fraud, and practical steps to protect yourself.', to: '/learn/ai-and-offensive-cybersecurity', difficulty: 'Intermediate', topicGroup: 'AI and society' },
  { type: 'lesson', title: 'AI and the benefits system',          description: 'How AI processes Universal Credit claims, detects fraud, and makes decisions affecting millions — and your rights when the algorithm gets it wrong.', to: '/learn/ai-and-benefits-system', difficulty: 'Intermediate', topicGroup: 'AI and society' },
  { type: 'lesson', title: 'AI and music creation',               description: 'AI music generators, voice cloning controversies, how Spotify recommends music, and what it means for professional musicians.', to: '/learn/ai-and-music-creation', difficulty: 'Intermediate', topicGroup: 'AI in the real world' },
  { type: 'lesson', title: 'AI and ageing and elder care',        description: 'Fall detection sensors, medication reminders, companion robots like PARO, AI hearing aids, and the ethics of monitoring elderly people.', to: '/learn/ai-and-ageing-and-elder-care', difficulty: 'Beginner', topicGroup: 'AI and society' },
  { type: 'lesson', title: 'AI and critical thinking',            description: 'ChatGPT in schools, Ofqual policy, cognitive offloading research, and the skills that AI cannot replace.', to: '/learn/ai-and-critical-thinking', difficulty: 'Intermediate', topicGroup: 'AI and society' },
  { type: 'lesson', title: 'AI and gig workers',                  description: 'How algorithmic management works, why ratings are a trap, the 2021 Uber Supreme Court ruling, and ADCU legal victories for gig workers.', to: '/learn/ai-and-gig-workers', difficulty: 'Intermediate', topicGroup: 'AI and society' },
  { type: 'lesson', title: 'AI and fashion technology',           description: 'AI trend forecasting, virtual try-on, AI-designed garments, sustainable fashion analytics, the resale market, and what automation means for garment workers.', to: '/learn/ai-and-fashion-tech', difficulty: 'Intermediate', topicGroup: 'AI in the real world' },
  { type: 'lesson', title: 'AI and the music industry',           description: 'Suno and Udio AI music generators, RIAA copyright lawsuits, Spotify\'s Discover Weekly algorithm, AI voice cloning controversies, and democratising music production.', to: '/learn/ai-and-music-industry', difficulty: 'Intermediate', topicGroup: 'AI in the real world' },
  { type: 'lesson', title: 'AI and sport betting',               description: 'How bookmakers use AI to set odds in real time, Betfair trading bots, in-play betting AI, addiction profiling, and the 2023 UK Gambling White Paper reforms.', to: '/learn/ai-and-sport-betting', difficulty: 'Intermediate', topicGroup: 'AI and society' },
  { type: 'lesson', title: 'AI and prisons and criminal justice', description: 'OASys risk assessment, facial recognition in courts, GPS licence monitoring, algorithmic parole decisions, racial bias, and your rights under GDPR.', to: '/learn/ai-and-prisons-and-criminal-justice', difficulty: 'Intermediate', topicGroup: 'AI and society' },
