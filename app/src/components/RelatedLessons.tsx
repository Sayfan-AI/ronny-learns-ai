...
const RELATED: Record<string, string[]> = {
  ...
  'ai-everyday-life':      ['ai-pros-and-cons', 'what-is-ai', 'ai-in-your-apps'],
  ...
  'ai-in-healthcare':      ['ai-bias', 'ai-pros-and-cons', 'ai-safety'],
  'future-of-ai':          ['ai-safety', 'ai-pros-and-cons', 'ai-in-healthcare'],
  'ai-in-your-apps':       ['what-is-ai', 'what-is-ml', 'how-chatbots-work'],
  'ai-laws-and-rights':    ['ai-bias', 'trusting-ai', 'ai-safety'],
  'ai-for-accessibility':  ['ai-in-healthcare', 'ai-in-your-apps', 'future-of-ai'],
  'ai-productivity-tools': ['ai-in-your-apps', 'prompt-engineering', 'ai-pros-and-cons'],
