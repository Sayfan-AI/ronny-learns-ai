...
const HIGHLIGHT_POOL: HighlightLesson[] = [
  ...
  { id: 'ai-and-jobs',          icon: '&#x1F4BC;', title: 'AI and jobs — what is really changing?',          description: 'What AI automates, assists, and cannot replace — and what new roles it creates.',               path: '/learn/ai-and-jobs',               difficulty: 'Beginner',     readingTime: '6 min' },
  { id: 'ai-and-creativity',    icon: '&#x1F3A8;', title: 'AI and creativity — art, music, and writing',    description: 'How AI tools help with creative work and why human creativity still matters.',                   path: '/learn/ai-and-creativity',         difficulty: 'Beginner',     readingTime: '6 min' },
  ...
  { id: 'ai-and-environment',   icon: '&#x1F331;', title: 'AI and the environment',                          description: 'The energy AI uses, its carbon footprint, and what the industry is doing.',                    path: '/learn/ai-and-environment',        difficulty: 'Intermediate', readingTime: '6 min' },
  { id: 'ai-and-privacy',       icon: '&#x1F512;', title: 'AI and privacy — who sees your data?',            description: 'How AI apps collect personal data, your rights, and practical tips to stay safe.',              path: '/learn/ai-and-privacy',            difficulty: 'Intermediate', readingTime: '6 min' },
  { id: 'ai-and-education',     icon: '&#x1F393;', title: 'AI and education',                                description: 'Personalised tutoring, teacher tools, academic integrity, and what AI cannot replace.',        path: '/learn/ai-and-education',          difficulty: 'Beginner',     readingTime: '6 min' },
  { id: 'ai-and-misinformation',icon: '&#x1F50E;', title: 'AI and misinformation',                           description: 'How AI creates convincing deepfakes and fake news — and how to fact-check.',                   path: '/learn/ai-and-misinformation',     difficulty: 'Intermediate', readingTime: '6 min' },
  { id: 'ai-and-mental-health', icon: '&#x1F9E0;', title: 'AI and your mental health',                       description: 'AI companion and therapy apps — their real benefits, risks, and how to use them wisely.',      path: '/learn/ai-and-mental-health',      difficulty: 'Beginner',     readingTime: '6 min' },
  ...
  { id: 'ai-and-social-media',  icon: '&#x1F4F2;', title: 'AI and social media',                             description: 'How recommendation algorithms shape your feed — and what you can do about it.',                 path: '/learn/ai-and-social-media',       difficulty: 'Beginner',     readingTime: '6 min' },
  ...
  { id: 'ai-and-food',          icon: '&#x1F33F;', title: 'AI and food',                                     description: 'How AI reduces pesticide use, cuts supermarket waste, detects food fraud, and powers delivery apps.', path: '/learn/ai-and-food',          difficulty: 'Beginner',     readingTime: '5 min' },
  { id: 'ai-and-sport',         icon: '&#x26BD;',  title: 'AI and sport',                                    description: 'GPS vests, expected goals, Hawk-Eye officiating, injury prediction, and personalised training.', path: '/learn/ai-and-sport',           difficulty: 'Intermediate', readingTime: '6 min' },
  { id: 'ai-and-transport',     icon: '&#x1F697;', title: 'AI and transport',                                description: 'Self-driving cars, smart traffic lights, how Google Maps works, and predictive maintenance.', path: '/learn/ai-and-transport',         difficulty: 'Beginner',     readingTime: '5 min' },
  { id: 'ai-and-art',           icon: '&#x1F58C;&#xFE0F;', title: 'AI and art',                             description: 'DALL-E, Midjourney, and diffusion models explained — plus the copyright debate and artist opt-outs.', path: '/learn/ai-and-art',         difficulty: 'Intermediate', readingTime: '6 min' },
]
