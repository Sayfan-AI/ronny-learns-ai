...
const aiAndAddictionRecoveryRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/learn/ai-and-addiction-recovery',
  component: withSuspense(AIAndAddictionRecovery),
})

const aiFactsAndMythsQuizRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/quiz/ai-facts',
...
const aiAndClimateTechRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/learn/ai-and-climate-tech',
  component: withSuspense(AIAndClimateTech),
})

const aiAndCreativeEconomyRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/learn/ai-and-creative-economy',
